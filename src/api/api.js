...
app.post('/make-fundraiser', async (req, res) => {
    ...
    const contractBytecode = fs.readFileSync("../../src_contracts_FundraiserContract_sol_FundraiserContract.bin")
    ...
    const contrractInstantiateTx = new ContractCreateTransaction()
        ...
        .setGas(100000)
        .setConstructorParameters(new ContractFunctionParameters().addUint256(id).addString(name).addUint256(goal));
...
app.get('get-fundraiser', async (req, res) => {
    // Get the given data
    const { id } = req;
    ...
    const contractQueryTx = new ContractCallQuery()
        ...
        .setGas(100000)
        .setFunction("getFundraiser", new ContractFunctionParameters().addUint256(id))
